###########################################################################
## Makefile generated for Simulink model 'Pacemaker_OperatingModes'. 
## 
## Makefile     : Pacemaker_OperatingModes.mk
## Generated on : Fri Oct 23 16:30:46 2020
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker_OperatingModes.elf
...
PRODUCT_NAME              = Pacemaker_OperatingModes
MAKEFILE                  = Pacemaker_OperatingModes.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/furqa/DOCUME~1/Uni/SFWREN~1/Project
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Pacemaker_OperatingModes_comp.rsp
CMD_FILE                  = Pacemaker_OperatingModes.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker_OperatingModes.elf
...
DEFINES_STANDARD = -DMODEL=Pacemaker_OperatingModes -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o Pacemaker_OperatingModes.o Pacemaker_OperatingModes_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_OperatingModes.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/Pacemaker_OperatingModes.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_OperatingModes_data.o : $(START_DIR)/Pacemaker_OperatingModes_ert_rtw/Pacemaker_OperatingModes_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
